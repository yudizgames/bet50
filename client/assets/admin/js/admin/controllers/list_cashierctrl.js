 ...
 */
angular.module('main').controller('CashierListCtrl',function ($scope,$rootScope,$resource,$http,$state,toastr,DTOptionsBuilder,DTColumnDefBuilder,DTColumnBuilder,$compile) {
    ...
    $scope.userOperation = function(iUserId,OperationType){
        ...
        if(OperationType == 'view'){
            $state.go('admin.cashierdetails',{'id':iUserId});
            ...
            $state.go('admin.cashierform',{'id':iUserId,'action':'Edit'});
        }
    }
    /**
